...
<div class="bg-neutral-900 min-h-screen flex flex-col gap-y-20 justify-center items-center">
	<div>
		<h1 class="text-5xl text-cyber-6 p-4 font-orbitron cursor-none">Admin Login</h1>
	</div>
	<form action="" class="flex flex-col gap-y-5" on:submit={handleSubmit}>
		<div class="form-control w-full max-w-xs">
			<label class="label flex-col">
				<span class="label-text self-start mb-2">Username</span>
				<input
					type="text"
		...
		<div class="form-control w-full max-w-xs">
			<label class="label flex-col">
				<span class="label-text self-start mb-2">Password</span>
				<input
					type="password"
					placeholder="Type here"
					name="password"
		...
		<button
			class="p-2 flex items-center justify-center hover:translate-x-2 transition-all duration-200"
		>
			<svg
